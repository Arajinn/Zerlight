...
namespace game
{
    ...
    std::shared_ptr<BodyPart> BodyPart::create(std::shared_ptr<BodySection> section, std::shared_ptr<properties::BodyPartDef> aBodyPartDef, std::string nameModifier, std::shared_ptr<BodyPart> containedBy,
                                               std::shared_ptr<Item> prostheticPart)
    {
    ...
    void BodyPart::init(std::shared_ptr<game::BodySection> section,std::shared_ptr<properties::BodyPartDef> aBodyPartDef, std::string nameModifier,
                               std::shared_ptr<game::BodyPart> containedBy,std::shared_ptr<game::Item> prostheticPart)
    {
