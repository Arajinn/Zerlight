...
#ifndef GUICHAN_ZTEXT_H
#define GUICHAN_ZTEXT_H
...
namespace gui {
    ...
    public:
         ...
         * @since 0.9.0
         */
        ZText(const std::string& content);
         ...
         * @since 0.9.0
         */
        virtual void setCaretPosition(int x, int y, std::shared_ptr<Font> font);
         ...
         * @since 0.9.0
         */
        virtual int getCaretX(std::shared_ptr<Font> font) const;
         ...
         * @since 0.9.0
         */
        virtual int getCaretY(std::shared_ptr<Font> font) const;
         ...
         * @since 0.9.0
         */
        virtual Rectangle getDimension(std::shared_ptr<Font> font) const;
         ...
         * @since 0.9.0
         */
        virtual Rectangle getCaretDimension(std::shared_ptr<Font> font) const;
         ...
         * @since 0.9.0
         */
        virtual int getWidth(int row, std::shared_ptr<Font> font) const;
