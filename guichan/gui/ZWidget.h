...
#ifndef GUICHAN_ZWIDGET_H
#define GUICHAN_ZWIDGET_H

#include "guichan/gui/ZColor.h"
#include "guichan/gui/Rectangle.h"
#include "guichan/gui/DefaultFont.h"
...
namespace gui {
     ...
     */
    class ZWidget : public inheritable_enable_shared_from_this<ZWidget>{
    public:
        /**
         ...
         * @since 0.1.0
         */
        virtual void draw_item(std::shared_ptr<Graphics> graphics) = 0;
         ...
         * @since 0.8.0
         */
        virtual void drawFrame(std::shared_ptr<Graphics> graphics);
         ...
         * @since 0.1.0
         */
        virtual std::shared_ptr<ZWidget> getParent() const;
        ...
        */
         ...
         * @since 0.1.0
         */
        const ZColor& getBaseColor() const;
         ...
         * @since 0.1.0
         */
        const ZColor& getForegroundColor() const;
         ...
         * @since 0.1.0
         */
        const ZColor& getBackgroundColor() const;
         ...
         * @since 0.6.0
         */
        const ZColor& getSelectionColor() const;
        ...
        */
         ...
         * @since 0.1.0
         */
        virtual void setFocusHandler(std::shared_ptr<FocusHandler> focusHandler);
         ...
         * @since 0.1.0
         */
        virtual std::shared_ptr<FocusHandler> getFocusHandler();
         ...
         * @since 0.1.0
         */
        void addActionListener(std::shared_ptr<ActionListener> actionListener);
         ...
         * @since 0.1.0
         */
        void removeActionListener(std::shared_ptr<ActionListener> actionListener);
         ...
         * @since 0.1.0
         */
        void addDeathListener(std::shared_ptr<DeathListener> deathListener);
         ...
         * @since 0.1.0
         */
        void removeDeathListener(std::shared_ptr<DeathListener> deathListener);
         ...
         * @since 0.1.0
         */
        void addMouseListener(std::shared_ptr<MouseListener> mouseListener);
         ...
         * @since 0.1.0
         */
        void removeMouseListener(std::shared_ptr<MouseListener> mouseListener);
         ...
         * @since 0.1.0
         */
        void addKeyListener(std::shared_ptr<KeyListener> keyListener);
         ...
         * @since 0.1.0
         */
        void removeKeyListener(std::shared_ptr<KeyListener> keyListener);
         ...
         * @since 0.7.0
         */
        void addFocusListener(std::shared_ptr<FocusListener> focusListener);
         ...
         * @since 0.7.0
         */
        void removeFocusListener(std::shared_ptr<FocusListener> focusListener);
         ...
         * @since 0.8.0
         */
        void addWidgetListener(std::shared_ptr<WidgetListener> widgetListener);
         ...
         * @since 0.8.0
         */
        void removeWidgetListener(std::shared_ptr<WidgetListener> widgetListener);
         ...
         * @since 0.1.0
         */
        virtual void setParent(std::shared_ptr<ZWidget> parent);
         ...
         * @since 0.1.0
         */
        static bool widgetExists(std::shared_ptr<const ZWidget> widget);
         ...
         * @since 0.9.0
         */
        virtual std::list<std::shared_ptr<ZWidget>> getWidgetsIn(const Rectangle& area, std::shared_ptr<ZWidget> ignore = nullptr);
         ...
         * @since 0.6.0
         */
        virtual const std::list<std::shared_ptr<MouseListener>>& getMouseListeners();
         ...
         * @since 0.6.0
         */
        virtual const std::list<std::shared_ptr<KeyListener>>& getKeyListeners();
         ...
         * @since 0.7.0
         */
        virtual const std::list<std::shared_ptr<FocusListener>>& getFocusListeners();
         ...
         * @since 0.1.0
         */
        virtual std::shared_ptr<FocusHandler> getInternalFocusHandler();
         ...
         * @since 0.1.0
         */
        void setInternalFocusHandler(std::shared_ptr<FocusHandler> internalFocusHandler);
         ...
         * @since 0.1.0
         */
        virtual void moveToTop(std::shared_ptr<ZWidget> widget);
         ...
         * @since 0.1.0
         */
        virtual void moveToBottom(std::shared_ptr<ZWidget> widget);
         ...
         * @since 0.1.0
         */
        virtual void showWidgetPart(std::shared_ptr<ZWidget> widget, Rectangle area);
         ...
         * @since 0.9.0
         */
        void add_child(std::shared_ptr<ZWidget> widget);
    ...
    protected:
         ...
         */
        std::list<std::shared_ptr<MouseListener>> mMouseListeners;
         ...
         */
        std::list<std::shared_ptr<ActionListener>> mActionListeners;

        /**
         * Holds the death listeners of the widget.
         */
        std::list<std::shared_ptr<DeathListener>> mDeathListeners;

        /**
         * Holds the focus listeners of the widget.
         */
        std::list<std::shared_ptr<FocusListener>> mFocusListeners;

        /**
         * Holds the widget listeners of the widget.
         */
        std::list<std::shared_ptr<WidgetListener>> mWidgetListeners;

        /**
         * Holds the foreground color of the widget.
         */
        ZColor mForegroundColor;
         ...
         * has no parent.
         */
        std::shared_ptr<ZWidget> mParent;
         ...
         */
        static std::shared_ptr<DefaultFont> mDefaultFont;
         ...
         */
        static std::list<std::shared_ptr<ZWidget>> mWidgetInstances;
