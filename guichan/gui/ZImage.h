...
#ifndef GUICHAN_IMAGE_H
#define GUICHAN_IMAGE_H
...
namespace gui {
    ...
    public:
         ...
         * @since 0.5.0
         */
        static std::shared_ptr<ZImage> load(const std::string& filename, bool convertToDisplayFormat = true);
         ...
         * @since 0.1.0
         */
        static std::shared_ptr<ImageLoader> getImageLoader();
         ...
         * @since 0.5.0
         */
        virtual ZColor getPixel(int x, int y) = 0;
         ...
         * @since 0.5.0
         */
        virtual void putPixel(int x, int y, const ZColor& color) = 0;
    ...
    protected:
         ...
         */
        static std::shared_ptr<ImageLoader> mImageLoader;
    };
}

#endif //GUICHAN_IMAGE_H
