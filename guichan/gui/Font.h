...
#ifndef GUICHAN_FONT_H
#define GUICHAN_FONT_H
...
namespace gui {
    ...
    public:
         ...
         */
        virtual void drawString(std::shared_ptr<Graphics> graphics, const std::string& text, int x, int y) = 0;
    };
}

#endif //GUICHAN_FONT_H
