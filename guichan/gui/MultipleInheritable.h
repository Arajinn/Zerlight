...
#ifndef GUICHAN_MULTIPLEINHERITABLE_H
#define GUICHAN_MULTIPLEINHERITABLE_H
...
public:
    ...
    {
        return std::dynamic_pointer_cast<T const>(MultipleInheritableEnableSharedFromThis::shared_from_this());
    }
...
#endif //GUICHAN_MULTIPLEINHERITABLE_H
