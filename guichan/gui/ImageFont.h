...
#ifndef GUICHAN_IMAGEFONT_H
#define GUICHAN_IMAGEFONT_H
...
namespace gui {
    ...
    public:
         ...
         *                   is missing.
         */
        ImageFont(std::shared_ptr<ZImage> image, const std::string& glyphs);
         ...
         */
        virtual int drawGlyph(std::shared_ptr<Graphics> graphics, unsigned char glyph,
                              int x, int y);
        ...
        virtual void drawString(std::shared_ptr<Graphics> graphics, const std::string& text,
                                int x, int y);
