...
#ifndef GUICHAN_ZSLIDER_H
#define GUICHAN_ZSLIDER_H
...
namespace gui {
     ...
     */
    class ZSlider : public ZWidget, public MouseListener, public KeyListener{
    public:
         ...
         */
        ZSlider();
        virtual void init(double scaleEnd = 1.0);
         ...
         * @param scaleEnd The end value of the slider scale.
         */
        virtual void init(double scaleStart, double scaleEnd);
    ...
    protected:
         ...
         */
        virtual void drawMarker(std::shared_ptr<Graphics> graphics);
