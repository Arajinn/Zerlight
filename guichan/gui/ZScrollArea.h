...
#ifndef GUICHAN_SCROLLAREA_H
#define GUICHAN_SCROLLAREA_H
...
namespace gui {
     ...
     * necessary.
     */
    class ZScrollArea : public ZWidget, public MouseListener{
    public:
         ...
         */
        virtual void init(std::shared_ptr<ZWidget> content);
         ...
         *                policies.
         */
        virtual void init(std::shared_ptr<ZWidget> content, ScrollPolicy hPolicy, ScrollPolicy vPolicy);
         ...
         */
        void setContent(std::shared_ptr<ZWidget> widget);
         ...
         */
        std::shared_ptr<ZWidget> getContent() const;
    ...
    protected:
         ...
         */
        virtual void drawBackground(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawUpButton(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawDownButton(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawLeftButton(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawRightButton(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawVBar(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawHBar(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawVMarker(std::shared_ptr<Graphics> graphics);
         ...
         * @param graphics a Graphics object to draw with.
         */
        virtual void drawHMarker(std::shared_ptr<Graphics> graphics);
